...
namespace DotnetAPIProject.Services.Implementations
{
    public class QuestionPictureService : IQuestionPictureService
    {
        ...
        //post
        public async Task<Guid> CreateQuestionTextAsync(PostQuestionTextRequest request)
        {
        ...
        // post img
        public async Task<Guid> CreateQuestionImageAsync(PostQuestionImageRequest request)
        {
            var questionId = Guid.NewGuid();
